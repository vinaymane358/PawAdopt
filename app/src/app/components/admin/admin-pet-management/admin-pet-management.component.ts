...
@Component({
  selector: 'app-admin-pet-management',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './admin-pet-management.component.html',
  styleUrls: ['./admin-pet-management.component.css']
})
export class AdminPetManagementComponent implements OnInit {
  pets: Pet[] = [];
  filteredPets: Pet[] = [];
  loading = true;
  showPetModal = false;
